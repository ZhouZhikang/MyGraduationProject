...
public class BackPropagationNeuralNetworks {  
     ...
     * @param epoch 
     */  
    public BackPropagationNeuralNetworks(int inputSize, int hiddenSize, int outputSize, double eta,  
            double momentum) {  
     ...
     * @param epoch 
     */  
    public BackPropagationNeuralNetworks(int inputSize, int hiddenSize, int outputSize) {  
